...
local function GeneralPurchase()
	...
	if ( bot:GetGold() >= cost ) then
		...
		if bot.SecretShop and courier ~= nil and courier:DistanceFromSecretShop() == 0 then
...
function ItemPurchaseThink()  
	...
	if PRoles.IsCoreHero(bot)
	or (PRoles.IsSupportHero(bot) and DotaTime() >= (30 * 60)) then
