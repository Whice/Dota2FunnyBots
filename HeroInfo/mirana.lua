...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, Starstorm:GetName())
	table.insert(abilities, SacredArrow:GetName())
	table.insert(abilities, Leap:GetName())
	table.insert(abilities, MoonlightShadow:GetName())
