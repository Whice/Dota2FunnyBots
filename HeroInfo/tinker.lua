...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, Laser:GetName())
	table.insert(abilities, MarchOfTheMachines:GetName())
	table.insert(abilities, DefenseMatrix:GetName())
	table.insert(abilities, Rearm:GetName())
