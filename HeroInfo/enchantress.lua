...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, Impetus:GetName())
	table.insert(abilities, Enchant:GetName())
	table.insert(abilities, NaturesAttendants:GetName())
	table.insert(abilities, Untouchable:GetName())
