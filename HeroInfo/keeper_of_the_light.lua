...
function X.GetHeroLevelPoints()
	...
	if Illuminate:IsHidden() then
		table.insert(abilities, SpiritFormIlluminate:GetName())
	else
		table.insert(abilities, Illuminate:GetName())
	end
	table.insert(abilities, BlindingLight:GetName())
	table.insert(abilities, ChakraMagic:GetName())
	table.insert(abilities, SpiritForm:GetName())
