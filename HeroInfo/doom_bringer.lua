...
function X.GetHeroLevelPoints()
	...
	table.insert(abilities, Devour:GetName())
	table.insert(abilities, ScorchedEarth:GetName())
	table.insert(abilities, InfernalBlade:GetName())
	table.insert(abilities, Doom:GetName())
