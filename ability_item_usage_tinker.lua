...
function AbilityUsageThink()
	...
	if WarpFlareDesire > 0 then
		bot:Action_UseAbilityOnEntity(WarpFlare, WarpFlareTarget)
		return
	end
	...
	if MarchOfTheMachinesDesire > 0 then
		bot:Action_UseAbilityOnLocation(MarchOfTheMachines, MarchOfTheMachinesTarget)
		return
	end
	
	KeenConveyanceDesire, KeenConveyanceTarget = UseKeenConveyance()
	if KeenConveyanceDesire > 0 then
		bot:Action_UseAbilityOnLocation(KeenConveyance, KeenConveyanceTarget)
		return
	end
