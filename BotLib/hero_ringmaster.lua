...
function X.ConsiderTameTheBeasts()
    ...
    then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, true, botTarget:GetLocation(), nOuterRadius, nOuterRadius, 0,
                0)
    ...
    then
        ...
        do
            ...
            then
                local nLocationAoE = bot:FindAoELocation(true, true, enemy:GetLocation(), nOuterRadius, nOuterRadius, 0,
                    0)
    ...
    then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, false, tEnemyLaneCreeps[1]:GetLocation(), nInnerRadius,
                nInnerRadius, 0, 0)
    ...
    then
        ...
        if #tEnemyLaneCreeps >= 4
            ...
            and (J.IsCore(bot) or not J.IsThereCoreNearby(1600))
        then
            nLocationAoE = bot:FindAoELocation(true, false, tEnemyLaneCreeps[1]:GetLocation(), nInnerRadius, nInnerRadius,
                0, 0)
            local targetLoc = J.GetCenterOfUnits(tEnemyLaneCreeps)
            if nLocationAoE.count >= 4
            then
    ...
    then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, false, tCreeps[1]:GetLocation(), nInnerRadius, nInnerRadius, 0,
                0)
    ...
    then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, false, tCreepsCanKill[1]:GetLocation(), nInnerRadius,
                nInnerRadius, 0, 0)
            if J.IsLaning(bot)
            then
                if #tCreepsCanKill >= 2
