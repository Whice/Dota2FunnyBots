        ...
        ['pos_1'] = {
            [1] = {
                ...
                ['sell_list'] = {
                    ...
                    "item_wraith_band", "item_silver_edge",
...
function X.ConsiderQ()
    ...
    then
        ...
        then
            ...
            for i = 0, 800, 200
            do
                local nCastLocation = J.GetLocationTowardDistanceLocation(npcTarget, J.GetEnemyFountain(),
                    nRadius + 800 - i)
    ...
    then
        local nCanHurtHeroLocationAoENearby = bot:FindAoELocation(true, true, botLocation, nCastRange - 400, nRadius, 1.5,
            0)
...
function X.ConsiderR()
    ...
    then
        nTempTarget = nAttackTarget
    end

    local nWeakestEnemyHeroInCastRange = X.GetWeakestUnitInRangeExRadius(nEnemysHerosCanSeen, nCastRange,
        nAttackRange - 300, bot)
