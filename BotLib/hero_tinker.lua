...
function X.ConsiderMarchOfTheMachines()
    ...
    then
        ...
        then
            ...
            then
                return BOT_ACTION_DESIRE_HIGH,
                    J.Site.GetXUnitsTowardsLocation(bot, nLocationAoE__A.targetloc, nCastRange)
            end
        end
    ...
    then
        ...
        then
            return BOT_ACTION_DESIRE_HIGH,
                J.Site.GetXUnitsTowardsLocation(bot, J.GetCenterOfUnits(nEnemyLaneCreeps), nCastRange)
        end
    ...
    then
        ...
        then
            ...
            then
                return BOT_ACTION_DESIRE_HIGH,
                    J.Site.GetXUnitsTowardsLocation(bot, J.GetCenterOfUnits(nNeutralCreeps), nCastRange)
            end
...
function X.ConsiderCombos()
    ...
    then
        ...
        then
            ...
            BlinkLocation = J.GetRandomLocationWithinDist(target:GetLocation(), Laser:GetCastRange() * 0.7,
                Laser:GetCastRange())
