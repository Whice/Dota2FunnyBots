    ...
    local HeroBuild = {
        ['pos_1'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_magic_wand_wraith_band_power_treads",
                ...
                ['sell_list'] = {
                    "item_quelling_blade", "item_invis_sword",
                    "item_magic_wand", "item_black_king_bar",
                    "item_wraith_band", "item_harpoon",
                    "item_falcon_blade", "item_silver_edge",
        ...
        ['pos_2'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_bottle_null_talisman_power_treads",
                ...
                ['sell_list'] = {
                    ...
                    "item_null_talisman", "item_silver_edge",
                    "item_falcon_blade", "item_abyssal_blade",
                    "item_power_treads", "item_travel_boots",
                },
            },
        },
            ...
            then
                ...
                then
                    return BOT_ACTION_DESIRE_HIGH,
                        J.Site.GetXUnitsTowardsLocation(bot, enemyHero:GetLocation(), nDashRange)
                end
            end
        end
    end
    ...
    then
        ...
        then
            ...
            then
                ...
                then
                    return BOT_ACTION_DESIRE_HIGH,
                        J.Site.GetXUnitsTowardsLocation(bot, weakestTarget:GetLocation(), nDashRange)
                end
            end
        end
    end
        ...
        do
            ...
            then
                ...
                then
                    ...
                    then
                        return BOT_ACTION_DESIRE_HIGH,
                            J.Site.GetXUnitsTowardsLocation(bot, creep:GetLocation(), nDashRange)
                    end
                end
