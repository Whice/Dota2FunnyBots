...
function X.ConsiderQ()
    ...
    local nCanKillCreepsLocationAoE = bot:FindAoELocation(true, false, bot:GetLocation(), nCastRange + nRadius, nRadius,
        0.5, nDamage)
    local nCanHurtCreepsLocationAoE = bot:FindAoELocation(true, false, bot:GetLocation(), nCastRange + nRadius, nRadius,
        0.5, 0)
...
function X.ConsiderW()
    ...
    local nEnemysHeroesInView = bot:GetNearbyHeroes(1600, true, BOT_MODE_NONE)
    if nEnemysHeroesInView ~= nil and #nEnemysHeroesInView <= 1 and nCastRange < bot:GetAttackRange() then
        nCastRange =
        bot:GetAttackRange() + 60
    end
