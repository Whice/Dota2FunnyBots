    ...
    local HeroBuild = {
        ['pos_1'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_magic_wand_null_talisman_power_treads",
        ...
        ['pos_3'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_magic_wand_null_talisman_phase_boots",
            ...
            then
                ...
                then
                    return BOT_ACTION_DESIRE_HIGH,
                        J.Site.GetXUnitsTowardsLocation(bot, enemyHero:GetLocation(), nCastRange)
                else
...
function X.ConsiderVacuumWall()
    ...
    then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, true, bot:GetLocation(), nVacuumCastRange, nVacuumRadius,
                nWallOfReplicaCastPoint, 0)
