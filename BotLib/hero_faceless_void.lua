    ...
    local HeroBuild = {
        ...
        ['pos_2'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_bottle_wraith_band_power_treads",
        ...
        ['pos_3'] = {
            [1] = {
                ...
                ['sell_list'] = {
                    ...
                    "item_orb_of_corrosion", "item_assault",
                    "item_power_treads", "item_travel_boots",
                },
            },
        },
...
function X.ConsiderTimeWalkReverse()
    ...
    then
        ...
        local isPrevLocDist1 = GetUnitToLocationDistance(bot, TimeWalkPrevLocation) >
            GetUnitToLocationDistance(botTarget, TimeWalkPrevLocation)
        local isPrevLocDist2 = GetUnitToLocationDistance(bot, TimeWalkPrevLocation) >
            GetUnitToUnitDistance(bot, botTarget)
    ...
    then
        ...
        then
            ...
            if nTargetInRangeAlly ~= nil and nInRangeAlly ~= nil
                ...
                and #nInRangeAlly <= 1
            then
                local nLocationAoE = bot:FindAoELocation(true, true, bot:GetLocation(), nCastRange, nRadius, nCastPoint,
                    0)
