...
function X.ConsiderSpearOfMars()
    ...
    then
        local nLocationAoE = bot:FindAoELocation(true, false, nEnemyLaneCreeps[1]:GetLocation(), 0, nRadius, nCastPoint,
            0)
    ...
    if J.IsFarming(bot) and nManaAfter > 0.35 and not J.IsLateGame() then
        ...
        then
            local nLocationAoE = bot:FindAoELocation(true, false, nEnemyCreeps[1]:GetLocation(), 0, nRadius, nCastPoint,
                0)
        ...
        do
            ...
            then
                ...
                if nTargetInRangeAlly ~= nil
                    ...
                    and #nInRangeAlly <= 1
                then
                    local nLocationAoE = bot:FindAoELocation(true, true, bot:GetLocation(), nCastRange, nRadius,
                        nCastPoint, 0)
