    ...
    local HeroBuild = {
        ['pos_1'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_magic_wand_bracer_power_treads",
                ...
                ['sell_list'] = {
                    ...
                    "item_bracer", "item_radiance",
                    "item_falcon_blade", "item_sphere",
        ...
        ['pos_2'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_bottle_bracer_power_treads",
        ...
        ['pos_3'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "itemx_melee_magic_wand_bracer_phase_boots",
        ...
        ['pos_4'] = {
            [1] = {
                ...
                ['buy_list'] = {
                    "item_soft_support_melee_outfit",
...
local CelestialHammerCastRangeTalent      = bot:GetAbilityByName(
...
function X.SkillsComplement()
    ...
    then
        ...
        then
            CelestialHammerCastRangeTalent = bot:GetAbilityByName(
                'special_bonus_unique_dawnbreaker_celestial_hammer_cast_range')
        ...
        CelestialHammerTime = DotaTime() + CelestialHammer:GetCastPoint() +
            (GetUnitToLocationDistance(bot, CelestialHammerLocation) / nSpeed)
        return
    end
...
function X.ConsiderStarBreaker()
    ...
    local nDamage = bot:GetAttackDamage() + Starbreaker:GetSpecialValueInt('swipe_damage') +
    ...
    then
        local nLocationAoE = bot:FindAoELocation(true, true, bot:GetLocation(), nRadius, nRadius,
            nComboDuration + nCastPoint, 0)
    ...
    then
        ...
        then
            ...
            then
                ...
                then
                    local aLocationAoE = bot:FindAoELocation(false, true, nTeamFightLocation,
                        GetUnitToLocationDistance(bot, nTeamFightLocation), nRadius, nTotalCastTime, 0)
                    local eLocationAoE = bot:FindAoELocation(true, true, nTeamFightLocation,
                        GetUnitToLocationDistance(bot, nTeamFightLocation), nRadius, nTotalCastTime, 0)
