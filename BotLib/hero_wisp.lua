...
function X.ConsiderTether()
    ...
    for _, ally in pairs(tAllyHeroes_real) do
        ...
        then
            ...
            then
                if allyPos == 1 then
                    allyScore = allyScore * 5
                elseif allyPos == 2 then
                    allyScore = allyScore * 2.5
                elseif allyPos == 3 then
                    allyScore = allyScore * 1
                elseif allyPos >= 4 then
                    allyScore = allyScore * 0.3
                end
...
function X.ConsiderSpirits_IO()
    ...
    local nSpiritsRangeFromIO = X.GetCurrentSpiritRangeFromIO(DotaTime() - SpiritsToggleTime, spirit_state, nMinRange,
        nMaxRange, nSpeed)
