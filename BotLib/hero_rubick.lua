...
local function HandleStolenSpell(stolenSpell)
    ...
    then
        heroAbilityUsage[stolenSpellHeroName] = dofile(GetScriptDirectory() ..
            '/BotLib/' .. string.gsub(stolenSpellHeroName, 'npc_dota_', ''))
    end
...
function X.ConsiderTelekinesisLand()
    ...
    then
        ...
        then
            ...
            then
                ...
                then
                    return BOT_ACTION_DESIRE_HIGH,
                        J.Site.GetXUnitsTowardsLocation(bot.teleTarget, bot:GetLocation(), nDistance)
                end
            end
            ...
            then
                return BOT_ACTION_DESIRE_HIGH,
                    J.Site.GetXUnitsTowardsLocation(bot.teleTarget, J.GetEnemyFountain(), nDistance)
            end
        end
