        ...
        ['pos_3'] = {
            [1] = {
                ...
                ['sell_list'] = {
                    ...
                    "item_falcon_blade", "item_assault"
                },
            },
        },
        ['pos_4'] = {
    ...
    then
        ...
        then
            ...
            do
                ...
                then
                    local nCreepCountAround = J.GetNearbyAroundLocationUnitCount(true, false, nRadius,
                        creep:GetLocation())
...
function X.ConsiderKineticFence()
    ...
    if J.IsInTeamFight(bot, 1200) then
        local nLocationAoE = bot:FindAoELocation(true, true, bot:GetLocation(), nCastRange, nRadius, nCastPoint + nDelay,
            0)
