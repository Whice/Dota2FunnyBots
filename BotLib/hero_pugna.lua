...
function X.ConsiderQ()
    ...
    then
        ...
        then
            local locationAoEKill = bot:FindAoELocation(true, false, bot:GetLocation(), nCastRange + 220, nRadius,
                nCastPoint, nDamage)
            ...
            local locationAoEHurt = bot:FindAoELocation(true, false, bot:GetLocation(), nCastRange + 220, nRadius + 50,
                0.8, 0)
...
function X.ConsiderW()
    ...
    then
        ...
        then
            return BOT_ACTION_DESIRE_HIGH, npcMostDangerousEnemy, "W-Battle" ..
                J.Chat.GetNormName(npcMostDangerousEnemy)
        end
    end
