...
function X.SkillsComplement()
    ...
    then
        if ShouldBoulderSmash then
            ...
            bot:ActionQueue_UseAbilityOnLocation(BoulderSmash,
                J.Site.GetXUnitsTowardsLocation(bot, J.GetTeamFountain(), 800))
            return
        else
            ...
            then
                ...
                then
                    return BOT_ACTION_DESIRE_HIGH,
                        J.Site.GetXUnitsTowardsLocation(bot, J.GetEnemyFountain(), nUnitKickDist), false, true
                else
    ...
    do
        ...
        then
            ...
            then
                ...
                elseif nStone >= 1
                then
                    vLocation = J.GetCorrectLoc(enemyHero,
                        (GetUnitToUnitDistance(bot, enemyHero) / (nSpeed + 600)) + nDelay)
