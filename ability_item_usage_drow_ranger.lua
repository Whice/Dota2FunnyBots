...
function AbilityUsageThink()
	...
	if GustDesire > 0 then
		...
		bot:ActionQueue_UseAbilityOnLocation(Gust, GustTarget)
		return
	end
	...
	if MultishotDesire > 0 then
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnLocation(Multishot, MultishotTarget)
		return
	end]]--
	...
	if FrostArrowsDesire > 0 then
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnEntity(FrostArrows, FrostArrowsTarget)
		return
	end
end
