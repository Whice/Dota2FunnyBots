...
function AbilityUsageThink()
	...
	if FlamebreakDesire > 0 then
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnLocation(Flamebreak, FlamebreakTarget)
		return
	end
	...
	if StickyNapalmDesire > 0 then
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnLocation(StickyNapalm, StickyNapalmTarget)
		return
	end
end
...
function UseFlamingLasso()
	...
	local CastRange = (PAF.GetProperCastRange(CR) + 100)
