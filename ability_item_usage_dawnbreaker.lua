...
function AbilityUsageThink()
	...
	if StarbreakerDesire > 0 then
		...
		bot:ActionQueue_UseAbilityOnLocation(Starbreaker, StarbreakerTarget)
		return
	end
	...
	if CelestialHammerDesire > 0 then
		...
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnLocation(CelestialHammer, CelestialHammerTarget)
		return
	end
	...
	if SolarGuardianDesire > 0 then
		PAF.SwitchTreadsToInt(bot)
		bot:ActionQueue_UseAbilityOnLocation(SolarGuardian, SolarGuardianTarget)
		return
	end
