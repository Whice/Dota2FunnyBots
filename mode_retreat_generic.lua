    ...
    if J.IsInLaningPhase() or botHP < 0.35 then
        ...
        for _, creep in pairs(nEnemyCreeps) do
            ...
            then
                ...
                bot:GetActualIncomingDamage(creep:GetAttackDamage() * creep:GetAttackSpeed() * 3.0, DAMAGE_TYPE_PHYSICAL)
            end
        end
        ...
        if J.IsValid(unit) and J.IsInRange(bot, unit, 1200) then
            ...
            if bot:GetTeam() ~= unit:GetTeam() then
                ...
                if string.find(sUnitName, 'tower') then
                    local towerDamage = bot:GetActualIncomingDamage(unit:GetAttackDamage() * unit:GetAttackSpeed() * 5.0,
    ...
    for _, unit in pairs(unitList) do
        ...
        then
            ...
            then
                ...
                local illusionDamage = bot:GetActualIncomingDamage(unitDamage, DAMAGE_TYPE_PHYSICAL) -
                botHealthRegen * 5.0
            ...
            then
                ...
                local spiderlingsDamage = bot:GetActualIncomingDamage(unitDamage, DAMAGE_TYPE_PHYSICAL) -
                botHealthRegen * 5.0
            ...
            then
                ...
                local eidolonDamage = bot:GetActualIncomingDamage(unitDamage, DAMAGE_TYPE_PHYSICAL) -
                botHealthRegen * 5.0
