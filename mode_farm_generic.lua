...
function GetDesire()
    ...
    then
        ...
        then
            ...
            "Use the local host instead of the official server to create the room, otherwise this robot will become invalid.",
                true);
        ...
        then
            ...
            if preferedCamp ~= nil then
                ...
                then
                    ...
                    return math.floor((RemapValClamped(farmDistance, 6000, 0, BOT_MODE_DESIRE_MODERATE, BOT_MODE_DESIRE_VERYHIGH)) *
                    10) / 10;
                end
            end
        end
...
function Think()
    ...
    if preferedCamp ~= nil then
        ...
        then
            ...
            then
                farmState                                  = 0;
                J.Role['availableCampTable'], preferedCamp = J.Site.UpdateAvailableCamp(bot, preferedCamp,
