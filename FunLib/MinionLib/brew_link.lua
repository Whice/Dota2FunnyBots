...
function X.Think(ownerBot, hMinionUnit)
    ...
    do
        ...
        then
            hMinionUnit.cast_desire, hMinionUnit.cast_target, hMinionUnit.cast_type = X.ConsiderBrewLinkSpell
            [hMinionUnit.abilities[i]:GetName()](hMinionUnit, hMinionUnit.abilities[i])
