        ...
        then
            ...
            then
                ...
                then
                    ...
                    local unitsAttackDamage = bot:GetActualIncomingDamage(J.GetUnitListTotalAttackDamage(tSerpents, 5.0),
                        DAMAGE_TYPE_PHYSICAL) - botHealthRegen * 5.0
                ...
                then
                    if not bOutnumbered and J.IsInRange(bot, unit, botAttackRange + 500) then
                        local unitAttackDamage = bot:GetActualIncomingDamage(X.GetUnitAttackDamageWithinTime(unit, 5.0),
                            DAMAGE_TYPE_PHYSICAL) - botHealthRegen * 5.0
                        botAttackDamage = unit:GetActualIncomingDamage(botAttackDamage, DAMAGE_TYPE_PHYSICAL) -
                        unitHealthRegen * 5.0
                ...
                then
                    if not bOutnumbered and J.IsInRange(bot, unit, botAttackRange + 300) and not J.IsRetreating(bot) then
                        ...
                        local unitsAttackDamage = bot:GetActualIncomingDamage(
                        J.GetUnitListTotalAttackDamage(tUnits, 5.0), DAMAGE_TYPE_PHYSICAL) - botHealthRegen * 5.0
                        local totalUnitHealth = X.GetTotalUnitHealth(tUnits)
                        botAttackDamage = J.GetTotalAttackDamageToUnits(botAttackDamage, tUnits, DAMAGE_TYPE_PHYSICAL) -
                        unitHealthRegen * 5.0
                ...
                then
                    ...
                    local unitAttackDamage = bot:GetActualIncomingDamage(J.GetUnitListTotalAttackDamage(tGolems, 5.0),
                        DAMAGE_TYPE_PHYSICAL) - botHealthRegen * 5.0
                    botAttackDamage = unit:GetActualIncomingDamage(X.GetUnitAttackDamageWithinTime(bot, 5.0),
                        DAMAGE_TYPE_PHYSICAL) - unitHealthRegen * 5.0
